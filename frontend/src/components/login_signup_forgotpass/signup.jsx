    ...
    return (
        <div className="flex items-center animate__animated animate__fadeIn">
            <form action="" method="post" className="w-[55%] text-gray-500 min-w-[350px] px-5 py-5 my-10 rounded-xl border-gray-300 border-[1px] mx-auto bg-white">
                ...
                <button
                    className="bg-white border font-semibold w-full lg:w-[50%] lg:ml-[25%] rounded-lg py-1 mt-10 border-mainCL border-1 text-mainCL
                    transition-colors duration-300 ease-linear hover:bg-mainCL hover:text-white">
                    Sign up
                </button>
                <Or />
