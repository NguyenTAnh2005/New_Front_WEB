export function SubscribleForm() {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 py-5 lg:py-12 bg-mainCL text-white px-10 lg:px-0 rounded-lg mt-1">
            ...
            <div className="flex flex-col items-center gap-5 mt-5 lg:flex-row lg:gap-10 lg:mt-0">
                ...
                <button className="hover:bg-white hover:text-mainCL rounded-xl text-[20px] xl:text-[24px] px-6 py-2 font-medium
