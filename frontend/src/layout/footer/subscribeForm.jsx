export function SubscribleForm() {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 py-5 lg:py-12 bg-orange-600 text-white mt-20">
            ...
            <div className="flex flex-col items-center gap-5 mt-5 lg:flex-row lg:gap-10 lg:mt-0">
                <input type="email" placeholder="Enter your email"
                    className="border border-gray-300 rounded-lg w-96 py-2.5 pl-2.5 text-black focus:outline-none" />
                <button className="bg-white text-black rounded-xl text-[24px] px-8 py-2
